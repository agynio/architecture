...
| **Files** | Data | Stores files in object storage, serves metadata and pre-signed download URLs. Agents access file content via [files-mcp](files-mcp.md) MCP server |
