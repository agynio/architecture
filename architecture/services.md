...
| Images | [agynio/image-catalog](https://github.com/agynio/image-catalog) | [Images Service](images-service.md) | Control plane | Owns the image catalog: image records and the versions discovered from their upstream repositories. |
| Image Proxy | [agynio/image-pull-proxy](https://github.com/agynio/image-pull-proxy) | [Image Proxy](image-proxy.md) | Data plane | Serves every workload image pull, authenticating upstream with catalog credentials that never leave the platform. |
