...
- **Port exposure** works as in agent workloads: `agyn expose add 3000` inside the sandbox returns an `http://exposed-<id>.agyn:3000` URL reachable from the engineer's enrolled devices.
