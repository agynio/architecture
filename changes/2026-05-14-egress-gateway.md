...
- A rule create attempt with `matcher.domain_pattern: "*.agyn"` (or `*.svc`, `*.cluster.local`, or any pattern overlapping `100.64.0.0/10`) is rejected at create time with a clear validation error.
