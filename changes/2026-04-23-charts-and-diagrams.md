...
- SPA: "View source" toggle on rendered charts and diagrams revealing the original code block
...
- The "View source" toggle reveals the original fenced code block for each rendered visualization.
